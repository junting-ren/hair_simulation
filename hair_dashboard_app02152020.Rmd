...
numericInput('thres', tagList("Graying threshold"), 
             value = 1920)
...
renderPlotly({
  ...
  ggplotly(
    dat_sim()$percentage_dat %>% 
      ...
      theme_bw()  + ylim(0,1)+ scale_y_continuous(labels = scales::percent, limits = c(0,1)) + 
      labs(y = "Proportion of gray hairs", x = "Age (years)")
  )
...
When the AgingFactorValue for ith hair reach a predefined threshold, the ith hair will turn gray. 
...
For more information please refer to the manuscript: Human Hair Graying is Naturally Reversible and Linked to Stress  
